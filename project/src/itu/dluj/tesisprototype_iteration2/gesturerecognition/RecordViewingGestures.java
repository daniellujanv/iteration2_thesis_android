...
public class RecordViewingGestures {
	...
	public Scalar green;
	public Scalar blue;
	public HashMap<String, Boolean> navigationState;
	public Mat mRgb;
	public Mat mHsv;
	...
	public RecordViewingGestures(int width, int height){
		navigationState = new HashMap<String, Boolean>();
		navigationState.put("Init", false);
		navigationState.put("End", false);
		navigationState.put("Rotate_Init", false);
		navigationState.put("Rotate_End", false);
		navigationState.put("Resize_Init", false);
		navigationState.put("Resize_End", false);
